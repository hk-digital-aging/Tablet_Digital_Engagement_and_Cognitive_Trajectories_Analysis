...
catVars <- c("Class")
file_prefix <- "s_tab_41_abs_monthly_frequency_cognitive_apps_month_"

dir.create(
  "~/Downloads/supplementary_table_41_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_41_abs_monthly_frequency_cognitive_apps.csv",
  row.names = FALSE
)
