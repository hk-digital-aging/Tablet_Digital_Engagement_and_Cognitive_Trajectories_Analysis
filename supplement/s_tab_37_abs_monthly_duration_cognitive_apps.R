...
catVars <- c("Class")
file_prefix <- "s_tab_37_abs_monthly_duration_cognitive_apps_month_"

dir.create(
  "~/Downloads/supplementary_table_37_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_37_abs_monthly_duration_cognitive_apps.csv",
  row.names = FALSE
)
