...
myVars <- c("ALL")
catVars <- c("Class")
file_prefix <- "s_tab_09_cum_monthly_duration_all_apps_month_"

dir.create(
  "~/Downloads/supplementary_table_9_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_9_cum_monthly_duration_all_apps.csv",
  row.names = FALSE
)
