...
catVars <- c("Class")
file_prefix <- "s_tab_31_abs_weekly_frequency_psychological_apps_week_"

dir.create(
  "~/Downloads/supplementary_table_31_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_31_abs_weekly_frequency_psychological_apps.csv",
  row.names = FALSE
)
