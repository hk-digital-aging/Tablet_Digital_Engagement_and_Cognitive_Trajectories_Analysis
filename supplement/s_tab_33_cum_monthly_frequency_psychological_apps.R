...
catVars <- c("Class")
file_prefix <- "s_tab_33_cum_monthly_frequency_psychological_apps_month_"

dir.create(
  "~/Downloads/supplementary_table_33_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_33_cum_monthly_frequency_psychological_apps.csv",
  row.names = FALSE
)
