...
catVars <- c("Class")
file_prefix <- "s_tab_28_cum_weekly_duration_psychological_apps_class3_vs_class4_week_"

dir.create(
  "~/Downloads/supplementary_table_28_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_28_cum_weekly_duration_psychological_apps_class3_vs_class4.csv",
  row.names = FALSE
)
