...
catVars <- c("Class")
file_prefix <- "s_tab_40_cum_monthly_duration_cognitive_apps_class3_vs_class4_month_"

dir.create(
  "~/Downloads/supplementary_table_40_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_40_cum_monthly_duration_cognitive_apps_class3_vs_class4.csv",
  row.names = FALSE
)
