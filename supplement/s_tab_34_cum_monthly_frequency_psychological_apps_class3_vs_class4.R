...
catVars <- c("Class")
file_prefix <- "s_tab_34_cum_monthly_frequency_psychological_apps_class3_vs_class4_month_"

dir.create(
  "~/Downloads/supplementary_table_34_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_34_cum_monthly_frequency_psychological_apps_class3_vs_class4.csv",
  row.names = FALSE
)
