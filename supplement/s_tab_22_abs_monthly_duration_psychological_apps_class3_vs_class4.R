...
catVars <- c("Class")
file_prefix <- "s_tab_22_abs_monthly_duration_psychological_apps_class3_vs_class4_month_"

dir.create(
  "~/Downloads/supplementary_table_22_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_22_abs_monthly_duration_psychological_apps_class3_vs_class4.csv",
  row.names = FALSE
)
