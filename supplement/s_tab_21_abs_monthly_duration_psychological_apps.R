...
catVars <- c("Class")
file_prefix <- "s_tab_21_abs_monthly_duration_psychological_apps_month_"

dir.create(
  "~/Downloads/supplementary_table_21_output/",
  recursive = TRUE,
  showWarnings = FALSE
)
...
write.csv(
  merged_data,
  file = "~/Downloads/supplementary_table_21_abs_monthly_duration_psychological_apps.csv",
  row.names = FALSE
)
